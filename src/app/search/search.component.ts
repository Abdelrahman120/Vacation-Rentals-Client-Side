...
@Component({
  selector: 'app-search',
  standalone: true,
  imports: [FormsModule, NgxDaterangepickerBootstrapDirective, NgxDaterangepickerBootstrapComponent],
  templateUrl: './search.component.html',
  styleUrls: ['./search.component.css'] // Fixed: 'styleUrls' is the correct key
})
export class SearchComponent implements OnInit {
  ...
  constructor(private route: Router, private propertyService: PropertyService, private activatedRoute: ActivatedRoute) { }
